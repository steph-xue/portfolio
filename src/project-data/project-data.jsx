export default [
    ...
    },
    {
        ...
        languages: "JavaScript, JSX, HTML, CSS",
        additionalInfo: "React, Vite, Imgflip, Netlify",
    ...
    },
    {
        ...
        languages: "JavaScript, JSX, HTML, CSS",
        additionalInfo: "React, React-split, React-mde, Showdown, Vite, Firebase, Netlify",
    ...
    },
    {
        ...
        description: 
            "My personal website is a component-first, dynamic web application built using the front-end JavaScript library, React. The web application highlights my personal interests, projects, technical skills, experiences, and contact information, which you can view using the navigation bar at the top. The site features a variety of interactive elements including a dark/light mode toggle, a randomized image gallery showcasing my photography, multiple project carousels, an animated console-style homepage, a subtle animated gradient background, and interactive images and buttons that provide a more engaging user experience. The randomized image gallery in the about me section generates a random selection of photography every time the page is reloaded. The project carousels in the projects section allow the user to scroll through thumbnails of different views of the corresponding project, open the image in full screen, as well as press play to view an animated slide show of all the associated images.",
        languages: "JavaScript, JSX, HTML, CSS",
