export default [
    ...
    },
    {
        ...
        description: 
            "My personal website (the website you are on right now) is a dynamic single-page web application built using the front-end JavaScript library, React. There is a navigation bar at the top that allows you to move between different sections of the web application, including the homepage, the about me page, the projects page, the experiences page, and the contact me page. There is also a toggle button at the top right of the navigation bar that allows you to switch between light mode and dark mode. Additionally, the image gallery in the about me section generates a selection of random photos I have taken to view every time the page is loaded. The screenshot carosels in the projects section allows the user to scroll through thumbnails of different screenshot images of the project to view, open the image in full screen, as well as press play to view an animated slide show of all the project images.",
        languages: "JavaScript, JSX, HTML, CSS",
